...
<div id="wrapper">
    ...
    <!-- Page Content -->
    <div id="page-wrapper">
        <form role="form" action="${pageContext.request.contextPath}/code/add" method="post" accept-charset="UTF-8">
            <div class="form-group">
                <label class="control-label" for="dictionarySuccess">字典名称</label>
                <input type="text" class="form-control" id="dictionarySuccess" name="name">
            </div>
            <p>

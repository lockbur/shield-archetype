            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <i class="fa fa-list"></i> 黑名单列表
                        <div class="pull-right">
                            <a href="/black/addblack" class="btn btn-success btn-xs">
                                <i class="fa fa-plus"></i> 增加名单
                            </a>
                        </div>
                    </div>
                    <!-- /.panel-heading -->
...
<script>
    $(document).ready(function () {
        var dataTable = $('#dataTables-example').DataTable({
            ...
            "searching": true,
            ajax: {
                url: '${pageContext.request.contextPath}/black/list/dataTables',
                method: 'POST',
